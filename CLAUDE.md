...
хэрэглэгчийн түвшинд; харилцагч/бараа/ажилтан; журнал). **Демо компани нь ТУСЛАХ
зам** (картын доод мөр) — зохиомол дата үнэ цэнийг хойшлуулж, холболтыг дахин
хийлгэдэг тул гол алхам БИШ. Харагдах нөхцөл `shouldShowWelcome`: хаагаагүй
