...
Монгол нягтлан бодох бүртгэлийн вэб программ. **Брэнд нэр: "Гоёл Кашмер ХХК"**
(UI, wordmark, metadata, copyright, AI prompt бүгд энэ нэрээр; repo/код дотоод
нэрээрээ entry-accounting хэвээр). Display фонт: Playfair Display
(latin+cyrillic — кирилл wordmark зурдаг тул Fraunces-ыг сольсон). Одоогийн байдал болон төлөвлөгдсөн feature-үүд:
