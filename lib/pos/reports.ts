...
//
// Энэ файл нь DB давхарга. Төрөл ба ЦЭВЭР нэгтгэлүүд (aggregateBy / summarize
// / aggregatePayments) нь `./report-types`-д — client component тэднийг
// ЭНДЭЭС БИШ тэндээс уншина (эс тэгвээс postgres драйвер browser bundle-д
// орж production build унана).
...
// Server талын дуудагчид нэг замаар уншиж болно.
