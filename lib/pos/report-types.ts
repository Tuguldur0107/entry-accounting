// Борлуулалтын дэлгэрэнгүй тайлангийн ТӨРӨЛ + ЦЭВЭР нэгтгэлүүд (docs/pos
// §5). Энэ модуль `@/lib/db`-г import ХИЙХГҮЙ — client component (борлуулалтын
// тайлангийн дэлгэц) эндээс уншдаг тул postgres драйвер browser bundle-д орох
// ёсгүй (lib/gl/journal-list-types.ts-тэй ИЖИЛ шалтгаан, CLAUDE.md §5b).
// DB-ээс ачаалах нь lib/pos/reports.ts.
