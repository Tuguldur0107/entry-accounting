...
export interface ReconciliationRow {
  ...
  /**
   * Клирингийн дансан дахь АР/АП баримтын (эх баримт) нөлөө — PO-гүй АП
   * нэхэмжлэхийн Dr клиринг г.м. (ENT-021). Зөрүүнээс ИЛ нэрлэж хасна.
   */
  sourceDocAmount: number;
  /** Дэд дэвтэр + PO хаалт + эх баримт − GL. */
  difference: number;
