...
export const STANDARD_ACCOUNTS: StandardAccount[] = [
  ...
  { number: "13110002", name: "Авлага — НӨАТ-гүй борлуулалт" },
  { number: "13620000", name: "НӨАТ оролтын данс" },
  { number: "13630000", name: "ААНОАТ-ын авлага" },
  { number: "13640000", name: "ХХОАТ-ын авлага" },
  { number: "13650000", name: "НДШ-ийн авлага" },
  { number: "13660000", name: "Бусад татварын авлага" },
  ...
  { number: "14900001", name: "Бараа материалын үнэлгээний нөөц (NRV, contra)" },
  ...
  { number: "31000003", name: "ААНОАТ өглөг" },
  { number: "31000004", name: "Суутган татварын өглөг" },
  { number: "31000005", name: "Хөрөнгийн татварын өглөг" },
  { number: "31000006", name: "Гаалийн татварын өглөг" },
  ...
  { number: "31600004", name: "Худалдан авагчийн дэлгүүрийн кредит (POS)" },
  { number: "31300001", name: "Худалдан авагчийн урьдчилгаа" },
  ...
  // Анхны нэвтрүүлэлтийн тайлбарлагдахгүй зөрүү (docs/deployment/onboarding.md
  // R6, OD-ONB-1) — хуримтлагдсан ашигт чимээгүй хаахын оронд энд, ноорог
  // журналаар, шалтгаантай. Нэрээр нь танигддаг тул дугаарыг өөрчилж болно.
  { number: "44000098", name: "Нээлтийн үлдэгдлийн зөрүү" },
  { number: "44000099", name: "Орлого/зарлагын нэгтгэлийн данс" },

  // ── 51 — Орлого ─────────────────────────────────────────────────────────────
  { number: "51100000", name: "Үйл ажиллагааны орлого" },
  { number: "51100002", name: "Борлуулалтын орлого — НӨАТ-гүй" },
  ...
  // POS (docs/pos §3.1) — рольуудын default дансууд
  { number: "51800002", name: "Кассын илүүдэл (POS ээлж)" },
  { number: "51900001", name: "Борлуулалтын хөнгөлөлт (contra)" },
  ...
  // SIM2-035: ЖДҮ-ийн нийтлэг зардлын дансууд — нягтлан биш хэрэглэгч данс
  // зохиохгүйгээр түрээс, цахилгаан … нэхэмжлэхээ бүртгэнэ.
  { number: "73100002", name: "Түрээсийн зардал" },
  { number: "73100003", name: "Цахилгаан, ус, дулааны зардал" },
  { number: "73100004", name: "Холбоо, интернэтийн зардал" },
  { number: "73100005", name: "Шатахуун, тээврийн зардал" },
  { number: "73100006", name: "Зар сурталчилгаа, маркетингийн зардал" },
  { number: "73100007", name: "Бичиг хэрэг, хангамжийн зардал" },
  { number: "73100008", name: "Банкны шимтгэлийн зардал" },
  { number: "73100009", name: "Засвар үйлчилгээний зардал" },
  { number: "73100010", name: "Мэргэжлийн үйлчилгээний зардал (хууль, аудит, зөвлөх)" },
  { number: "73100011", name: "Албан томилолтын зардал" },
  { number: "73100012", name: "Хүлээн авалтын зардал" },
  { number: "73100013", name: "Даатгалын зардал" },
  { number: "73100014", name: "Харуул хамгаалалт, цэвэрлэгээний зардал" },
  { number: "73100015", name: "Сургалт, хөгжлийн зардал" },
  { number: "73100016", name: "Албан татвар, төлбөр хураамж" },
  ...
  { number: "87100005", name: "Бараа материалын NRV бууруулалтын зардал" },
  { number: "87000004", name: "Үндсэн хөрөнгө данснаас хассаны олз/гарз" },
  { number: "87100007", name: "Татварын торгууль, алданги" },
  { number: "87000006", name: "Кассын дутагдал (POS ээлж)" },
  { number: "87000007", name: "Бөөрөнхийллийн зөрүү (POS)" },
...
const SEED_ACCOUNT_NUMBERS = [
  ...
  "13620000", // НӨАТ оролтын данс
  "31000001", // AP
  "31410000", // НӨАТ өглөг (гаралтын)
  ...
  "72100002", // НДШ ажил олгогчийн зардал
  "31420000", // НДШ өглөг
  "31430000", // ХХОАТ өглөг
  "31500001", // Цалингийн өглөг (нэт)
  "31900001", // Нөөц өр төлбөр (бусад суутгал)
];
