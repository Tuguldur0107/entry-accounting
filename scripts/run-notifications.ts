...
// Өдрийн дүрмүүд + и-мэйлийн хүргэлт хоёуланг ажиллуулна.
...
async function main() {
  ...
  console.log(JSON.stringify({ daily, email }, null, 2));
  process.exit(daily.errors.length + email.errors.length > 0 ? 1 : 0);
}
