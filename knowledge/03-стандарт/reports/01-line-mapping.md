...
**Мөнгөн гүйлгээний тайлан 2026-09-д хэрэгжив** (`lib/reports/cf-lines.ts` +
cash-flow-view) — ХОЁР хэмжигдэхүүнээр: (1) `report_line_mappings.cf_codes`
багана дахь **S8 мөнгөн урсгалын кодууд** (журналын контра мөрийн S8 сегмент
таарвал дансны таарцаас ТҮРҮҮЛЖ энэ мөрөнд орно), (2) контра **үндсэн данс**
(`accountNumbers`, бусад тайлантай ижил). CF_LINES-ийн default prefix-үүд
хуучин classifyCashFlow ангиллыг (1x→үйл ажиллагаа, 2x→ХО, 3x/4x→санхүү,
5–8x→үйл ажиллагаа) давхцалгүй бүрэн хуваасан тул default дүн хуучин
тайлантай ижил. Аль ч мөрөнд таараагүй урсгал classifyCashFlow секцийнхээ
**"Ангилагдаагүй урсгал"** мөрөнд ИЛ харагдаж subtotal-д ордог тул
"Эхний + Цэвэр = Эцсийн" тулгалт mapping-аас үл хамааран хадгалагдана; урсгал
бүр яг нэг мөрөнд ордог тул давхар тооллого бүтцээрээ боломжгүй. AI
`get_cash_flow` мөн ижил resolveCfLines + buildMappedCashFlow-ыг ашиглана
(тест: `tests/cf-mapping.test.ts`).

**e-Balance маягт (2026-09-25):** `lib/reports/ebalance.ts` (ЦЭВЭР, тесттэй
`tests/ebalance.test.ts`) нь ЭНЭ ГУРВАН mapping-ийн үр дүнг Сангийн яамны
Цахим санхүүгийн тайлангийн системийн маягтын мөрөнд буулгана — СТ-1
санхүүгийн байдал (эхний/эцсийн), СТ-2 орлогын дэлгэрэнгүй, СТ-3 өмчийн
өөрчлөлт (багана бүр Entry-ийн эздийн өмчийн мөр), СТ-4 мөнгөн гүйлгээ (шууд
арга: S8 стандарт код → маягтын мөр `EBALANCE_CF_CODE_ROW`; кодгүй урсгал
Entry-ийн CF мөрийн ЧИГЛЭЛЭЭР «бусад» мөрүүдэд). Маягт бүрийн мөр Entry-ийн
аль мөрөөс бүрдснийг `sources`-д, харгалзах мөргүй маягтын мөрийг 0 + `note`
гэж ИЛ хэлнэ — дүн ЗОХИОХГҮЙ, нягтлан гараар нөхнө. Хуудас `/gl/reports?report=ebalance`
(4 зүсэлт таб, Excel 4 хуудастай нэг файл), AI/MCP `get_ebalance_statements`
НЭГ функцээр. Мөрийн дугаарлалт стандарт маягтын дараалал — e-Balance-ийн
тухайн жилийн маягттай тулгахад `EBALANCE_*_FORM` жагсаалтыг л засна.
...
│                        accountNumbers CSV, cfCodes CSV*, updatedAt)│
│  * cfCodes — зөвхөн cash-flow: S8 кодууд, данснаас түрүүлж таарна │
