...
> **2026-09-25 (фаз 2):** `01-онол-хууль-стандарт/`, `02-нягтлан-бодох-мэргэжлийн/`,
> `04-ai-agent/skills/` нь **ХУВИЙН repo `Tuguldur0107/entry-knowledge`** руу
> зөөгдсөн — «AI нягтлан» бүтээгдэхүүний агуулга тул core болон fork-д байхгүй.
> Энэ хавтсанд зөвхөн `03-стандарт/` ба `04-ai-agent/agents/` үлдсэн. Хөгжүүлэлтэд
> `entry-knowledge`-ийг core-ийн хажууд `../entry-knowledge` болгон clone хийнэ
> (`docs/knowledge/00-proposal.md` §6, root `CLAUDE.md` §9e). Доорх 01 / 02 /
> 04-skills хэсгүүд тэр repo-гийн бүтцийг тайлбарлана.
...
**`01-онол-хууль-стандарт/`** — `entry-knowledge` (хувийн)
...
**`02-нягтлан-бодох-мэргэжлийн/`** — `entry-knowledge` (хувийн)
