...
**Төлөв:** **БАТЛАГДСАН (2026-09-19) — D1–D7 бүгд саналын дагуу; фаз 0–2 хэрэгжсэн** · **Огноо:** 2026-09-19
...
| **2 — Сувгууд + нэмэлт дүрэм** ✅ ХЭРЭГЖСЭН | `NotificationChannel` interface (`lib/custom/types.ts`, validate, loader); Telegram суваг + холболт; `invoice.viewed`, `ai.drafts_created`, `bank.unmatched`, `fx.rate_missing`, `fx.reval_due`, `stock.negative`, `doc.large_amount` (D2); toast + дуу | 2–3 өдөр |
