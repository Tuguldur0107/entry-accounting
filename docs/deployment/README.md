...
| 6 | Тохиргоо → AI холболт (`/settings/ai`) → ChatGPT / Claude-д OAuth-оор Connect (эсвэл Claude Code / Codex-д token) | Харилцагч | Вэб |
...
| Зам | Хэзээ | Баримт |
|-----|-------|--------|
| **MCP** (`/api/mcp`) | Claude Code, Cowork, claude.ai, ChatGPT — хүн AI-тай ярьж ажиллуулна | Тохиргоо → AI холболт (`/settings/ai`) |
