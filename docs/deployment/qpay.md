...
Дахин холбоход (**[QPay дахин холбох]**) ЗӨВХӨН энэ Entry-ийн интеграцийн key
солигдоно (2026-09-26-аас dashboard интеграц бүрд тусдаа key олгодог) — мерчантын
гар key, бусад интеграц (staging Entry, MCP) хөндөгдөхгүй.

**Key автоматаар сэргэнэ** (`QPAY_PARTNER_KEY` тохируулсан SaaS-д): dashboard 401
буцаавал Entry Partner API-аар өөрийн key-г шинээр авч хүсэлтээ давтана; webhook-ийн
гарын үсэг таарахгүй бол одоогийн secret-ийг авч дахин шалгана. Хэрэглэгч юу ч
хийхгүй — аудитад `credentials_recovered`. Сэргээж чадаагүй (партнер key алга,
мерчант идэвхгүй) үед л [QPay дахин холбох].
...
1. **Тохиргоо → Компанийн мэдээлэл** бүрэн бөглөнө: нэр, регистр (ААН 7 орон
   ...
   и-мэйл. Код ЗОХИОГДОХГҮЙ — дутуу бол QPay табд улаанаар нэрлэгдэнэ
   (`lib/qpay/provision.ts`, тесттэй)
1b. **Касс → Данс** — QPay төлбөр орох данс = **кассын модулийн банкны данс**
   (нэг эх сурвалж; компанийн мэдээллийн данс нь зөвхөн нэхэмжлэхийн толгойд).
   Банкны дансанд: банк **жагсаалтаас** (QPay 6 оронтой код), дугаар, данс
   эзэмшигч (хоосон бол компанийн нэр), IBAN сонголтоор, **«QPay төлбөр хүлээн
   авах»** switch (MNT банкны данс л), **«Байгууллагын үндсэн QPay данс»** (нэг
   л — бусдаас автоматаар авагдана; үндсэнгүй бол эхний тэмдэглэсэн данс).
   Тэмдэглэсэн данс бүр dashboard руу sync хийгдэнэ
1c. **Салбар = агуулах.** Бараа → Агуулах → «QPay төлбөр орох данс» — тэр
   агуулахын ээлжээс үүссэн QR төлбөр ТЭР данс руу (dashboard
   `payout_account_number`, зөвхөн sync-лэсэн данс — бүртгэлгүй бол 400, данс
   зохиохгүй); сонгоогүй агуулах байгууллагын үндсэн данс руу. Сонгосон данс
   тэмдэг/идэвхгүй болсон бол QR үүсгэхэд ИЛ алдаа (өөр данс руу чимээгүй
   шилжихгүй). GL/settlement өөрчлөлтгүй — нэг «QPay түр данс», банкны
   хуулгаар тэгшитгэнэ
...
4. **Кассын данс хадгалах / идэвх солих / устгахад** (QPay-д хамаатай юу
   өөрчлөгдвөл) Entry → dashboard `PUT /api/partner/merchants/{id}/bank-accounts`
   (Entry эх сурвалж; дутуу бол sync алгасаж toast анхааруулна, хадгалалт
   унахгүй). QPay табын [Данс sync] гараар мөн. Компанийн мэдээллийн данс
   өөрчлөхөд sync ҮГҮЙ (2026-09-25-аас). Хуучин sync-лэсэн байгууллагад
   preDeploy нэг удаа: company_settings-ийн данстай ДУГААРААР таарах кассын
   банкны дансыг тэмдэглэнэ (код/IBAN/эзэмшигч/үндсэн дагуулж)
