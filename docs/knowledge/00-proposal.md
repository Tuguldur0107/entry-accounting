...
| **D2** | Хандалт = багцын боломж **`knowledge`** (`lib/billing/plans.ts`). **Аль ч багцад default OFF** — Entry Console байгууллага бүрд `overrides.features.knowledge` асаана. dedicated-д ч OFF: агуулга Entry-ээс л ирдэг |
