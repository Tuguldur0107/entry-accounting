...
| 6 | `taxType: "NOT_VAT"` ба `"NO_VAT"` (НӨАТ төлөгч бус тест мерчант байвал) | Аль нь хүлээн авагдах — Entry 2026-09-26-наас НӨАТ төлөгч бус байгууллагад `NOT_VAT`-аар илгээнэ (P2-16) |
...
| P2-16 | НӨАТ төлөгч бус байгууллага: хуулиар баримт олгох үүрэгтэй (product owner, 2026-09-26) — Entry одоо `NOT_VAT` + `totalVAT` 0-оор илгээнэ (хориг хасагдсан). `NOT_VAT`-ийн SDK тайлбар «хилийн гадна борлуулсан» | Эхний бодит баримтын хариуг шалгах; PosAPI татгалзвал `/rest/info.merchants[].customers[].vatPayer`-ийн дагуу өөр taxType-ийг ITC-ээс тодруулах |
