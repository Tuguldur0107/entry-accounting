...
зүүн талд барааны TILE, баруун талд баримт (ticket) + numpad.
...
│                                              │ Атар талх · 3 ш          Хөнг %: 10      │
│                                              │ [7][8][9][Тоо ] [4][5][6][Хөнг%]         │
│                                              │ [1][2][3][Үнэ ] [0][.][⌫]                │
...
- **Сканнер = гар** (keyboard wedge): хайлтын input ҮРГЭЛЖ focus-той — tile, мөр,
  numpad, товч бүр `mousedown`-ыг `preventDefault` хийж focus-ыг булаахгүй.
  Enter → яг таарсан barcode → яг таарсан код → эхний илэрц (`resolveScan`).
- **Баримтын мөр**: товшиж сонгоно (дахин товшвол сонголт арилна), −/+, ×;
  сонгосон мөрд **numpad** Тоо / Хөнг % горимоор тухай бүр орно. Кассаас ҮНЭ
  ЗАСАХГҮЙ (2026-09-24): үнэ = барааны картын борлуулах үнэ (жинлэдэг бараанд
  ...
  AI/MCP-д `pos:post` зөвшөөрөлтэй хэвээр
  (`pressNumpad` / `applyNumpad`, тесттэй); тоо 0 → мөр хасагдана; үнэ зассан
  мөр улбар шар (сервер `minSalesPrice`-ээр зөвшөөрөл шаардана). Физик гарын
  тоо numpad-д ОРОХГҮЙ (сканнерын оролттой андуурагдахаас сэргийлж) — гарын
  хэрэглэгч ↑/↓ мөр, + / − тоо, Delete хасна.
- **Купон + баримтын хөнгөлөлт** тусдаа диалогт (F4) — панель цэвэрхэн.
