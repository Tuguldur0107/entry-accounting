...
### 4.1 Кассын дэлгэц `/inventory/pos` — v2 (дэлгүүрийн POS загвар, 2026-09-19)

v1 нь «сканнер + сагсны хүснэгт» (нягтлангийн харагдац) байсан; v2 нь Odoo /
Square / Loyverse-ийн заншлаар **хүрэлцэх дэлгэцийн** дэлгүүрийн POS болов:
зүүн талд барааны TILE, баруун талд баримт (ticket). Numpad 2026-09-26-нд хасагдсан
(пилотын санал: хэрэглэгч «Хөнг %»-ийг ойлгохгүй, мөр сонгохгүйгээр товч идэвхгүй
байсан) — тоо −/+ эсвэл мөр дээр шууд бичнэ, бүх хөнгөлөлт F4 цонхонд.

```
┌ Касс  [SH-2609-003]  Касс: Төв дэлгүүр  Агуулах: [AG-01 ▾]  Кассчин: Б.Сарнай  14:32   [Ээлж хаах] ┐
├──────────────────────────────────────────────┬──────────────────────────────────────────┤
│ [🔍 Сканнер · barcode · нэр · код … ⏎   (F3)]│ (харилцагч энд БАЙХГҮЙ — төлбөрийн цонхонд) │
│ (Бүгд) (Ундаа) (Хүнс) (Амттан) (Гэр ахуй)    │ 1 Кока-Кола 0.5л               5,000.00 │
│ ┌──────────┐ ┌──────────┐ ┌──────────┐ …     │   2 × 2,500.00           [−] 2 [+]  ×  │
│ │Кока-Кола │②│Атар талх │ │Сүү 1л    │       │ 2 Атар талх ◀ сонгосон         5,940.00 │
│ │0.5л      │ │          │ │          │       │   3 × 2,200 −660 (10%)   [−] 3 [+]  ×  │
│ │2,500  12ш│ │2,200  40ш│ │4,300   0ш│       │ ⚠ 2 бараа хасах үлдэгдэлтэй болно      │
│ └──────────┘ └──────────┘ └──────────┘       │ Нийт 50,300 · Хөнгөлөлт −660 · НӨАТ 4,513│
│ …tile grid (auto-fill, ≥ 9.75rem)…           │ ═══ ТӨЛӨХ            49,640 ₮ ═══        │
│                                              │ [Хөнгөлөлт F4] [Түр хадгалах ③] [Цэвэрлэх]│
│                                              │ ████ ТӨЛБӨР · 49,640 ₮  (F9) ████        │
└──────────────────────────────────────────────┴──────────────────────────────────────────┘
```

- **Tile** = нэр (2 мөр) + үнэ + үлдэгдэл (≤0 бол улбар шар); сагсанд байвал
  булангийн badge-д тоо; борлуулах үнэгүй бараа бүдэг, товшвол шалтгаан
  (үнэ ЗОХИОХГҮЙ). Бүлгийн chip = `FilterChips` (`inventory_categories`; лавлахад
  байхгүй кодтой бараа кодоороо chip болно). Хайлт tile-ийг ГАЗАР ДЭЭР нь шүүнэ.
- **Сканнер = гар** (keyboard wedge): хайлтын input ҮРГЭЛЖ focus-той — tile, мөр,
  товч бүр `mousedown`-ыг `preventDefault` хийж focus-ыг булаахгүй; мөрийн ТОО-г
  товшиж бичихэд л түр focus авч, Enter / Esc / blur-т хайлт руу буцна.
  Enter → яг таарсан barcode → яг таарсан код → эхний илэрц (`resolveScan`).
- **Баримтын мөр**: товшиж сонгоно (дахин товшвол сонголт арилна), −/+, ×;
  тоог мөр дээр шууд бичнэ («1,35» — жинлэдэг бараа; `parseQuantityInput`,
  тесттэй); тоо 0 → мөр хасагдана. Кассаас ҮНЭ ЗАСАХГҮЙ (2026-09-24): үнэ = барааны картын борлуулах үнэ (жинлэдэг бараанд
  кг-ийн үнэ, жин = тоо); буулгах нь хөнгөлөлтөөр (хязгаар, тайлан, contra данс),
  өсгөх нь барааны карт дээр (үнийн түүх). Серверийн `unitPrice` override нь
  AI/MCP-д `pos:post` зөвшөөрөлтэй хэвээр. Гарын хэрэглэгч ↑/↓ мөр, + / − тоо, Delete хасна.
- **Купон, баримтын ба МӨРИЙН % хөнгөлөлт** НЭГ диалогт (F4) — панель цэвэрхэн;
  мөрийн % бичих тухай бүр сагсанд орно (`parseDiscountPercentInput`, 0–100).
- **Түр хадгалах (парк)** = олон сагс (агуулах бүрд ≤ 20, localStorage): худалдан
  авагч мөнгөө авахаар явахад сагсыг хадгалаад дараагийнхыг үйлчилнэ; сэргээхэд
  одоогийн сагс автоматаар парклана. Ноорог сагс мөн автоматаар хадгалагдаж
  хуудас дахин ачаалахад сэргэнэ. DB-д ноорог үүсгэхгүй.
- **Ээлж нээгээгүй** бол дэлгэц дээр НЭГ ТОВЧНЫ диалог: касс / агуулах / эхний
  мөнгө сүүлийн ээлжээс default (`CheckoutData.lastShift`; эхний мөнгө = сүүлийн
  хаагдсан ээлжийн тоолсон бэлэн), валютын ханш хумигдсан. Касс ба агуулах
  ганц бол сонголтгүй — зөвхөн «Ээлж нээх». Олон салбартай бол ЭНЭ ТӨХӨӨРӨМЖ
  дээр сүүлд нээсэн касс + агуулах анхдагч болно (`lib/pos/shift-device.ts`,
  localStorage, 2026-09-26) — байгууллагын сүүлийн ээлж (өөр салбарынх байж
  болно) дараа нь; эхний мөнгөний санал зөвхөн тэр ээлжийн кассад Ээлж хаах нь мөн дэлгэц дээрээ.
- Үнэ / хөнгөлөлт CLIENT талд тооцогдохгүй (`quotePosSale`, 250мс debounce);
  «ТӨЛӨХ» том тоо, ТӨЛБӨР товч дүнтэйгээ.
- **Харилцагч кассын дэлгэцэд сонгогдохгүй** (2026-09-26, пилот): ердийн
  борлуулалт дотоод «Бэлэн худалдан авагч»-аар; зээл / урьдчилгаа / кредит мөр
  нэмэгдэхэд л төлбөрийн цонхонд «Харилцагч (авлага / өглөг)» сонгогч гарна
  (бэлэн худалдан авагч жагсаалтад байхгүй). Харилцагчийн бүлгийн хөнгөлөлт
  тэнд сонгосон үед quote дахин бодогдож үйлчилнэ.
- Товчлуур: F9 төлбөр · F3 эсвэл "/" хайлт · F4 хөнгөлөлт ·
  ↑/↓ мөр · + / − тоо · Delete мөр хасах · Esc сонголт → сагс цэвэрлэх.
- Баримтын панель нь **өгөгдлийн хүснэгт биш** — хүрэлцэх дэлгэцийн ticket
  (баримтын preview-тэй ижил ангилал), тиймээс AG Grid-ийн стандарт хамаарахгүй.

Файлууд: `components/pos/pos-checkout-view.tsx` (orchestrator) →
`components/pos/checkout/{product-panel,ticket-panel,discount-dialog,parked-dialog}.tsx`;
цэвэр төлөв `lib/pos/checkout-state.ts` (`tests/pos-checkout-state.test.ts`).
