...
| **T4** | Хотын татвар (НХАТ) | ✅ 2026-09-26: тохиргооны % (default 0, байгууллага өөрөө бичнэ) + өглөгийн данс роль (31440000) + барааны `cityTaxable`; POS тооцоололд НӨАТ-тай зэрэгцээ мөр |
...
| Хотын татвар | НХАТ тусдаа (`totalCityTax`) | §5 | ✅ T4 (2026-09-26) — `cityTaxable` бараанд `pos_settings.cityTaxPercent`-оор |
