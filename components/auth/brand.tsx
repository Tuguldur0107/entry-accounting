...
export function EAMark({ size = 32 }: { size?: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 40 40" aria-label="Entry Accounting">
      ...
      <rect x="11" y="11" width="18" height="3" rx="1" fill="#fff" />
      <rect x="11" y="18.5" width="13" height="3" rx="1" fill="#fff" opacity="0.8" />
      <rect x="11" y="26" width="18" height="3" rx="1" fill="#fff" />
    </svg>
  );
}
