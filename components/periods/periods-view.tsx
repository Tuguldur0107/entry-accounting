...
const ACTION_ERRORS: Record<string, string> = {
  ...
  "unvalued-movements":
    "Сарын өртгийн тооцоололд ороогүй (эсвэл хасах үлдэгдэл г.м. шалтгаанаар зогссон) бараа хөдөлгөөн байна — Өртөг → Сарын өртөг тооцоод, зогссон барааг засна уу.",
  exists: "Энэ тайлант үе аль хэдийн бүртгэлтэй байна.",
  "previous-open":
    "Өмнөх тайлант үе нээлттэй байна — тайлант үеийг дарааллаар нь хаана уу.",
  "later-closed":
    "Дараагийн тайлант үе хаалттай байна — эхлээд түүнийг дахин нээнэ үү.",
  "not-closed": "Энэ тайлант үе хаалттай биш байна.",
