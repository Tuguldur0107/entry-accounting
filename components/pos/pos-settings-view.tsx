      ...
      {preview?.available && (
        <div className="rounded-md border border-[var(--ea-border)] bg-[var(--ea-surface)] p-3 text-xs">
          ...
          <p className="text-[var(--ea-text-3)]">
            Компанийн мэдээлэл (Тохиргоо → Компанийн мэдээлэл: регистр, MCC, хот/дүүрэг, хаяг, утас) +
            кассын модулийн банкны данс (Касс → Данс → «QPay төлбөр хүлээн авах» — банк жагсаалтаас, ★ үндсэн)
            QPay самбар руу илгээгдэж мерчант үүснэ; key, webhook secret автоматаар ирнэ; данс өөрчлөгдвөл
            хадгалахад дагаж шинэчлэгдэнэ. Салбар бүр өөрийн данс руу: Бараа → Агуулах → «QPay төлбөр орох
            данс» (сонгоогүй бол үндсэн данс). QPay самбарын нэвтрэх эрх эзний и-мэйлд
